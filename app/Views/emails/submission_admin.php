...
<head>
    <meta charset="utf-8">
    <title>Formulir Baru Masuk</title>
</head>
                                ...
                                <tr>
                                    <td style="padding:24px 32px 32px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f8fbff;border:1px solid #dbe7f5;border-radius:16px;margin-bottom:18px;">
                                            <tr>
                                                <td style="padding:22px 24px;">
                                                    <div style="font-size:13px;color:#64748b;margin-bottom:6px;">Informasi Formulir Baru</div>
                                                    <div style="font-size:28px;font-weight:700;color:#1e3a8a;margin-bottom:12px;">Ada Formulir Masuk</div>
                                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;color:#334155;">
                                                        ...
                                                        <tr>
                                                            <td style="padding:4px 0;">Pengirim Formulir</td>
                                                            <td align="right" style="padding:4px 0;font-weight:700;"><?= esc($submission['applicant_name']) ?></td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div style="font-size:15px;line-height:1.7;color:#334155;margin-bottom:18px;">
                                            Halo <?= esc($admin['nama'] ?? 'Admin') ?>,<br>
                                            Sistem menerima formulir baru dari <strong><?= esc($submission['applicant_name']) ?></strong>. Berikut ringkasan data yang dikirim.
                                        </div>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" style="margin-bottom:18px;">
                                            <tr>
                                                <td style="border-radius:999px;background:#1e3a8a;">
                                                    <a href="<?= esc($adminUrl) ?>" style="display:inline-block;padding:12px 20px;color:#ffffff;text-decoration:none;font-weight:700;">Buka Detail Pengajuan</a>
                                                </td>
                                            </tr>
                                        </table>

                                        <div style="font-size:13px;line-height:1.7;color:#64748b;">
                                            Email ini dikirim otomatis oleh <?= esc($siteName) ?>.
                                        </div>
                                    </td>
                                </tr>
                            </table>
